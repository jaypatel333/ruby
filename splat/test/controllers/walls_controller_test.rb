...
class WallsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wall" do
    assert_difference('Wall.count') do
      post walls_url, params: { wall: { access_id: @wall.access_id, title: @wall.title, user_id: @wall.user_id } }
    end
  ...
  test "should update wall" do
    patch wall_url(@wall), params: { wall: { access_id: @wall.access_id, title: @wall.title, user_id: @wall.user_id } }
